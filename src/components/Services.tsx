...
const mechanicalServices = [
  {
    title: "Sửa máy hút bụi",
    desc: "Sửa lỗi mô-tơ, thay túi lọc, bảo trì định kỳ tại nhà.",
